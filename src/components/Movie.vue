    ...
    <div id="movie">
        ...
        <div id="infos_movie">
            ...
            <div id="details_movie">
                ...
                <ul>
                    <li>
                        <b>Titre original :</b> {{ this.original_title }}
                    </li>
                    <li>
                        <b>Résumé :</b> {{ this.overview }}
                    </li>
                    <li>
                        <b>Genre(s) :</b> <span v-for="(genre,index) in this.genres" v-bind:key='index'>
                                                {{ genre.name }}<span v-if="genres[index+1]">, </span>
                                            </span>
                    </li>
                    <li>
                        <b>Langage originale :</b> {{ this.original_language }}
                    </li>
                </ul>
